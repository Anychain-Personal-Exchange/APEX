...
The AnyChain solution will be implemented via the Agile Scrum and the Product Backlog is currently implemented within Yodiz. [foo]: https://www.yodiz.com/ "title" Yodiz (https://www.yodiz.com/) is a simple but comprehensive agile tool which helps to manage Agile projects of all levels of complexity. </td>
  </tr>
  <tr>
